 ...
 * @since   1.2
 */
public class MapBuffer<K,V> extends AbstractMap<K,V> implements Map<K,V>, Cloneable, Serializable {
    // -- Attributes -- \\
    @java.io.Serial
    private static final long serialVersionUID = 215008869409516033L;
     ...
     */
    public MapBuffer(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public MapBuffer(int initialCapacity) {
     ...
     */
    public MapBuffer(Map<? extends K, ? extends V> m) {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final Spliterator<K> spliterator() {
            return new KeySpliterator<>(MapBuffer.this, 0, -1, 0, 0);
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public final Spliterator<V> spliterator() {
            return new ValueSpliterator<>(MapBuffer.this, 0, -1, 0, 0);
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public final Spliterator<Map.Entry<K,V>> spliterator() {
            return new EntrySpliterator<>(MapBuffer.this, 0, -1, 0, 0);
        }
    ...
    public synchronized Object clone() {
        MapBuffer<K,V> result;
        try {
            result = (MapBuffer<K, V>)super.clone();
    ...
    private static final class UnsafeHolder {
        ...
        static void putLoadFactor(MapBuffer<?, ?> map, float lf) {
    ...
    final class KeyIterator extends HashIterator implements Iterator<K> {
        public synchronized final K next() { return (K)nextNode().key; }
    }

    final class ValueIterator extends HashIterator implements Iterator<V> {
        public synchronized final V next() { return (V)nextNode().value; }
    }

    final class EntryIterator extends HashIterator implements Iterator<Map.Entry<K,V>> {
        public synchronized final Map.Entry<K,V> next() { return nextNode(); }
    }

    /* ------------------------------------------------------------ */
    // spliterators

    static class MapBufferSpliterator<K,V> {
        final MapBuffer<K,V> map;
        ...
        MapBufferSpliterator(MapBuffer<K,V> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<K,V>
            extends MapBufferSpliterator<K,V>
            implements Spliterator<K> {
        KeySpliterator(MapBuffer<K,V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(MapBuffer<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(MapBuffer<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class TreeNode<K,V> extends Entry<K,V> {
         ...
         * this node.
         */
        final Node<K,V> untreeify(MapBuffer<K,V> map) {
         ...
         */
        final TreeNode<K,V> putTreeVal(MapBuffer<K,V> map, Node<K,V>[] tab,
                                               int h, K k, V v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(MapBuffer<K,V> map, Node<K,V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(MapBuffer<K,V> map, Node<K,V>[] tab, int index, int bit) {
            TreeNode<K,V> b = this;
